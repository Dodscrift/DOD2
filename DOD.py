...
import random
def random_ua():
    model = "iPhone"+str(random.randint(4,16))+','+str(randon.randint(1,9))
...
def main_apv():
    ...
    r1 = requests.get('https://github.com/Dodscrift/DOD/blob/main/DOD.txt').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20DOD%20Owner%20MUGHAL-XD%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://wa.me/+923495147094?text='+tks)
        main_apv()
main_apv()
